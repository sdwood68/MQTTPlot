...
// Same discrete zoom window options used by SingleTopicPlot
...
export class MultiTopicPlotPreview {
  ...
  async zoomIn() {
    ...
    const windowMs = (this.currentEnd && this.currentStart) ? Math.max(1000, this.currentEnd - this.currentStart) : WINDOW_OPTIONS_MS[3];
